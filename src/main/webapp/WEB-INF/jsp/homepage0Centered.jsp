...
<body>
  ...
  <header class="container">
    ...
    <section class="content">
     <blockquote> <h1>Erik D Mueller </h1></blockquote>
      <p class="sub-title"><strong>A picture is worth a thousand words</strong> <br /> to see the background image change in size</p>
    
    
    
    
      <p><a class="button" id="load-more-content" href="#top">CONTACT</a></p>
	  <p><a class="button" id="load-more-content" href="#top"> RESUME </a></p>
	  <p><a class="button" id="load-more-content" href="#top">PORTFOLIO</a></p>
